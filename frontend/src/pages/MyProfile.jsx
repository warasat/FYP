  ...
  return (
    ...
    <div className="flex items-center mb-8">
      ...
      <div className="ml-6 flex-1 text-center md:text-left">
        ...
        <p className="text-gray-600 mt-1">Cardiologist | 10+ Years Experience</p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="flex flex-col items-center">
        <div className="bg-orange-100 rounded-full w-16 h-16 flex items-center justify-center">
          <img src="path/to/chronic-disease-icon.svg" alt="Chronic Disease Icon" className="w-8 h-8" />
        </div>
        <p className="text-gray-700 mt-2 text-center">Chronic Disease Management</p>
      </div>
      
      {/* Ear, Nose, and Throat */}
      <div className="flex flex-col items-center">
        <div className="bg-green-100 rounded-full w-16 h-16 flex items-center justify-center">
          <img src="path/to/ear-nose-throat-icon.svg" alt="Ear Nose and Throat Icon" className="w-8 h-8" />
        </div>
