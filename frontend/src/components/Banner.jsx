...
function Banner() {
  ...
  <button className="btn bg-blue-900 text-white hover:bg-blue-400 rounded-full px-10 py-2">I`m Patient</button>
  <button className="btn  bg-blue-900 text-white hover:bg-blue-400  rounded-full px-10 py-2">I`m Doctor</button>
</div>
          </div>
